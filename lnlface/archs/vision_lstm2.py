...
from lnlface.archs.vision_lstm_util import interpolate_sincos, to_ntuple, VitPatchEmbed, VitPosEmbed2d, DropPath, SequenceConv2d
...
def parallel_stabilized_simple(
    ...
    log_fg_matrix = torch.where(ltr, _log_fg_matrix[:, :, 1:, 1:], torch.tensor(-float("inf"), dtype=_dtype, device=_device))  # (B, NH, S, S)
