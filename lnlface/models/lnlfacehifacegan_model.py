...
class LNLFaceHiFaceGANModel(SRModel):
    ...
    def __init__(self, opt):
        ...
        pure_load = self.opt['pretrain_network_init'].get('init', False)
    ...
    def optimize_parameters(self, current_iter):
        ...
        if self.net_d is None or (current_iter % self.net_d_iters == 0 and current_iter > self.net_d_init_iters):
            # pixel loss
            if self.cri_pix:
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        for val_data in dataloader:
            ...
            if save_img:
                ...
                imwrite(tensor2img(visuals['result'], min_max=(-1, 1)), save_img_path)
